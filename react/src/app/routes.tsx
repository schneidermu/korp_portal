...
const UserTreePage = lazy(() => import("@legacy/features/UserTree/UserTree"));
const UserListPage = lazy(() => import("@legacy/features/UserList/UserList"));
const ProfilePage = lazy(() => import("@legacy/features/Profile/Profile"));

const BusinessCardPage = lazy(
  () => import("@legacy/features/BusinessCard/BusinessCardPage"),
);
...
const PollsDashboardPage = lazy(
  () => import("@legacy/features/Poll/list/PollsDashboardPage"),
);
const FormDashboardPage = lazy(
  () => import("@legacy/features/Poll/form/FormDashboardPage"),
);
const TakePollPage = lazy(
  () => import("@legacy/features/Poll/take/pages/TakePollPage"),
);
const ViewPollPage = lazy(
  () => import("@legacy/features/Poll/take/pages/ViewPollPage"),
);
const CreatePollPage = lazy(
  () => import("@legacy/features/Poll/edit/pages/CreatePollPage"),
);
const EditPollPage = lazy(
  () => import("@legacy/features/Poll/edit/pages/EditPollPage"),
);
const PollStatsPage = lazy(
  () => import("@legacy/features/Poll/take/pages/PollStatsPage"),
);
