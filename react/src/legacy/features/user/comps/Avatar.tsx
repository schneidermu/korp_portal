...
import { resolveMediaPath } from "@legacy/shared/utils";
import { cropImg } from "@legacy/shared/utils/cropImg";

import { FileInput } from "@legacy/shared/comps/FileInput";
...
export const AvatarEditable = React.memo(function AvatarEditable({
  user,
  onUpload,
  ...rest
}: { user: User; onUpload: (src: string) => void } & BoxProps) {
  ...
  return (
    <Box w="32" h="32" position="relative" {...rest}>
      <Box
        w="full"
        h="full"
        borderRadius="full"
