...
import { drawRoundedChain } from "@legacy/features/UserTree/utils";
...
const NodeWrapper = ({
  ...
  const clickable = editing && node.kind === "unit";
  ...
  return (
    <Box
      ...
      borderWidth={2}
      borderRadius="2"
      onClick={() => clickable && dispatch(actions.nodeOpened(node.id))}
      _hover={{
        borderColor: clickable ? "black" : undefined,
