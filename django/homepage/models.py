...
class Poll(Published):
    ...
    is_anonymous = models.BooleanField("Анонимный опрос", default=False)
    ...
    is_multiple_choice = models.BooleanField(
        "Несколько вариантов ответа", default=False
    )

    question_text = models.CharField(
        verbose_name="Текст опроса", max_length=CHARFIELD_LENGTH
    )
...
class Choice(models.Model):
    ...
    poll = models.ForeignKey(
        Poll, verbose_name="Опрос", on_delete=models.CASCADE, related_name="choices"
    )
    choice_text = models.CharField(
        verbose_name="Текст вопроса", max_length=CHARFIELD_LENGTH
    )
